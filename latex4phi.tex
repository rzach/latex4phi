...
\mode<article>{\hypersetup{colorlinks,allcolors=blue}}
...
\begin{frame}[fragile,allowframebreaks,containsverbatim]{A Simple \LaTeX{} Document}

\verbatiminput{latex4phi-sample}
\end{frame}
