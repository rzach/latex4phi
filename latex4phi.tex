...
\begin{itemize}
\item Non-\LaTeX-using supervisors won't be able to comment on your document
\item Non-\LaTeX-using collaborators won't be able to make changes
\item {\color{red}Non-\LaTeX-using publishers will make you convert your document to Word.}
\end{itemize}
